...
namespace BooksSerialization
{
    ...
    public class Book
    {
        ...
        [XmlElement("publisher",DataType = "string", Order = 4)]
        public string Publisher { get; set; }
        [XmlElement("publish_date", Order = 5)]
        public DateTime PublishDate { get; set; }
        [XmlElement("genre", Order = 6)]
        public static Enum Genre { get; set; }
        [XmlElement("description", Order = 7)]
        public string Description { get; set; }
        [XmlElement("registration_date", Order = 8)]
