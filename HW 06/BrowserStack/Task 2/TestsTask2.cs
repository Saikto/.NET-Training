...
namespace BrowserStack.Task_2
{
    ...
    public class TestsTask2 : BrowserStackNUnitTest
    {
        public TestsTask2(string profile, string environment) : base(profile, environment) { }
        ...
        [Test]
        public void TstAdvSearchCase1BS()
        {
            //TEST SETUP//
        ...
        [Test]
        public void TstAdvSearchCase2BS()
        {
            //TEST SETUP//
        ...
        [Test]
        public void TstAdvSearchCase3BS()
        {
            //TEST SETUP//
        ...
        [Test]
        public void TstAdvSearchCase4BS()
        {
            //TEST SETUP//
